...
{
    /// <summary>
    ///  Unit tests class for Complete Borrow page
    /// </summary>
    public class CompleteBorrow
    {
        #region TestSetup

        // Instance of Complete Borrow Model
        public static CompleteBorrowModel pageModel;

        /// <summary>
        /// Initializing method that creates an 
        /// object of the CompleteBorrowModel
        /// </summary>
        [SetUp]
        public void TestInitialize()
        {
            pageModel = new CompleteBorrowModel(TestHelper.ProductService) { };
        }
